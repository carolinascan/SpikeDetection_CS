function [allSpikes,class0,class1,class2,class3,class4,class5]=DoClustering(spiketime_ms,recording_length,spikes)
...
%% DATI
% spikes_nc=uigetfile('*.mat');
% template=uigetfile('*.mat');
load('C:\Users\Carolina\Desktop\TESI\DATI\Modello da visual inspection\spikes_1.mat');
spikes_nc=spikes; 
template=spikes;
%% CLUSTERIZZAZIONE
nspk = size(spiketime_ms,1);
index=spiketime_ms;
