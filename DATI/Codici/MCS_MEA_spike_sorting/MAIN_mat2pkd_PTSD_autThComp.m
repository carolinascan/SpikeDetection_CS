...
[plp, rp, art_thresh_analog, art_thresh_elec, art_dist, nstd, fs, w_pre, w_post, interpolation, cancelFlag]= uigetRTSDinfo_VP;
...
%         thresh_vector, nstd, mat_folder, pkd_folder)
    peak_detection_PTSD_mex_autThComp_VP (plp, rp, fs, art_thresh_analog, art_thresh_elec, art_dist, ...
