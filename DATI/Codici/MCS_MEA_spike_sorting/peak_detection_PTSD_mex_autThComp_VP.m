function [] = peak_detection_PTSD_mex_autThComp_VP (peakDuration, refrTime, fs, art_thresh_analog, art_thresh_elec, art_dist, thresh_vector, multCoeff, w_pre, w_post, interpolation, matfolder, pkdfolder)
