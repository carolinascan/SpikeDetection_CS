function [subfoldername]= uigetfoldernameBE(exp_num, bin, window, end_folder, endstring)
% Get folder names for the cross-correlation results
% by Michela Chiappalone (9 Maggio 2005, 25 Maggio 2006)

subfoldername = strcat(exp_num, '_BurstEvent_CCorr_', num2str(bin), '-', num2str(window), endstring);
