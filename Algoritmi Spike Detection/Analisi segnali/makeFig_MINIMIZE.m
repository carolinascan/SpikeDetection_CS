function makeFig_MINIMIZE(ax,list_window,INDEX,parameter,level_snr,title_figure,method)
if strcmp(method,'ATLM')
    ...
    title(ax,['Min ' num2str(title_figure) ' = ' num2str(MIN_index,'%1.2f') ' Max ' num2str(title_figure) ' = ' num2str(MAX_index,'%1.2f') ])
    caxis(ax,[0 1])
    colorbar(ax)
    ylabel(ax,'MultCoeff')
