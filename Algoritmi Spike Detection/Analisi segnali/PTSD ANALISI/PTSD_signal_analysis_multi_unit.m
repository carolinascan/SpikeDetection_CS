function [analysis] = PTSD_signal_analysis_multi_unit(struct,loc_spikes,data)
spikes_found_from_algorithm=find(struct.peak_train);
NS=length(spikes_found_from_algorithm);
spikes_position1=loc_spikes.unit1;
spikes_position2=loc_spikes.unit2;
spikes_position3=loc_spikes.unit3;
...
%% MATCHING SPIKES 
[spikes_found_matched,spikes_found_matched_from_model,fp,fn] = match_spikes(spikes_found_from_algorithm,timestamps_from_model');
%% GIT CALCULATION
