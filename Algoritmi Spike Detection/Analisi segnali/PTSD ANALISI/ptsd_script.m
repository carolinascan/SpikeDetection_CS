...
%     load([path_to_multiunit_notfilt 'SNR ' num2str(list_snr(i)) '\Distribuzioni 1\1\signoise1_SNR' num2str(list_snr(i)) '.mat']); 
    for j=1:length(parameter)
        ...
        load(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Dati\THRESH_VECTOR\param39\thresh_vector_param' num2str(parameter(j)) '_snr' num2str(list_snr(i)) '.mat']);
...
save('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\PTSD ANALISI\PTSD\param_PLP_snr\param_PLP_snr1','timestamps_found_all_SNR1','list_PLP','parameter','list_snr','-v7.3')
%%
save('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\PTSD ANALISI\PTSD\param_PLP_snr\param_PLP_snr13','timestamps_found_all_SNR13','list_PLP','parameter','list_snr','-v7.3')
%%
save('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\PTSD ANALISI\PTSD\param_PLP_snr\param_PLP_snr115','timestamps_found_all_SNR115','list_PLP','parameter','list_snr','-v7.3')
%%
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_multi_unit(timestamps_found_all_SNR1{j,k},loc_spike_s1);
    end
end

% save('Analisi segnali\PTSD ANALISI\PTSD\param_PLP_snr\roc_snr1_modified','roc','list_PLP','parameter')

save('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\PTSD ANALISI\PTSD\param_PLP_snr\roc_snr1','roc','list_PLP','parameter')
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_multi_unit(timestamps_found_all_SNR13{j,k},loc_spike_s1);
    end
end
...
%% save timestamps 
% it's too big just for just one matrix :( 
timestamps_found_all_SNR1_=cell(length(parameter),length(list_PLP));
timestamps_found_all_SNR13=cell(length(parameter),length(list_PLP));
timestamps_found_all_SNR115=cell(length(parameter),length(list_PLP));
%%
timestamps_found_all_SNR1_=timestamps_found_all(:,:,1);
timestamps_found_all_SNR13=timestamps_found_all(:,:,2);
timestamps_found_all_SNR115=timestamps_found_all(:,:,3);
%%
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR1_{j,k},expo_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR13{j,k},expo_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR115{j,k},expo_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR1_{j,k},gamma_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR13{j,k},gamma_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR115{j,k},gamma_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR1_{j,k},invgau_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR13{j,k},invgau_matrix);
    end
end
...
for j=1:length(parameter)
    for k=1:length(list_PLP)
        roc{j,k} = PTSD_signal_analysis_single_unit(timestamps_found_all_SNR115{j,k},invgau_matrix);
    end
end
