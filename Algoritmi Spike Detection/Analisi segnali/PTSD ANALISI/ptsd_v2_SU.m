...
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\PTSD ANALISI\PTSD\SINGLE UNIT V2\easy\timestamps_firstHalf_all_andtime.mat'],'timestamps_found_all','elapsed_time', '-v7.3')
...
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\PTSD ANALISI\PTSD\SINGLE UNIT V2\easy\ANALYSIS_secondHalf.mat'],'TP_all2','FP_all2','EFF2','list_parameter','list_snr','TN_all2','FN_all2','SPECIFICITY2','SENSITIVITY2','PRECISION2','GIT_all2','FOR_all2','FN_rate_all2','FP_rate_all2','MCC_all2','FDR_all2','F1_SCORE2','ACCURACY2','NPV_all2','TS_TP_all2','TS_TP_FROM_MODEL_all2')
...
for l=1:length(chosen_snr)
    ...
    makeFig_MAXIMIZE(ax,list_PLP,(squeeze(SENSITIVITY((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure1,method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_PLP,(squeeze(FP_rate_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure2,method)
end 
ax3=subplot(3,2,5)
makeFig_MAXIMIZE(ax3,list_PLP,(squeeze(SENSITIVITY2(5,:,:))),list_parameter,list_snr(l),title_figure1,method)
ax4=subplot(3,2,6)
makeFig_MINIMIZE(ax4,list_PLP,(squeeze(FP_rate_all2(5,:,:))),list_parameter,list_snr(l),title_figure2,method)
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_PLP,(squeeze(PRECISION((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure1,method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_PLP,(squeeze(FOR_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure2,method)
end 
ax3=subplot(3,2,5)
makeFig_MAXIMIZE(ax3,list_PLP,(squeeze(PRECISION2(5,:,:))),list_parameter,list_snr(l),title_figure1,method)
ax4=subplot(3,2,6)
makeFig_MINIMIZE(ax4,list_PLP,(squeeze(FOR_all2(5,:,:))),list_parameter,list_snr(l),title_figure2,method)
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_PLP,(squeeze(SPECIFICITY((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure1,method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_PLP,(squeeze(FN_rate_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure2,method)
end 
ax3=subplot(3,2,5)
makeFig_MAXIMIZE(ax3,list_PLP,(squeeze(SPECIFICITY2(5,:,:))),list_parameter,list_snr(l),title_figure1,method)
ax4=subplot(3,2,6)
makeFig_MINIMIZE(ax4,list_PLP,(squeeze(FN_rate_all2(5,:,:))),list_parameter,list_snr(l),title_figure2,method)
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_PLP,(squeeze(NPV_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure1,method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_PLP,(squeeze(FDR_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure2,method)
end 
ax3=subplot(3,2,5)
makeFig_MAXIMIZE(ax3,list_PLP,(squeeze(NPV_all2(5,:,:))),list_parameter,list_snr(l),title_figure1,method)
ax4=subplot(3,2,6)
makeFig_MINIMIZE(ax4,list_PLP,(squeeze(FDR_all2(5,:,:))),list_parameter,list_snr(l),title_figure2,method)
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_PLP,(squeeze(EFF((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure1,method)
    ax2=subplot(3,2,l*2)
    makeFig_MAXIMIZE(ax2,list_PLP,(squeeze(ACCURACY((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure2,method)
end 
ax3=subplot(3,2,5)
makeFig_MAXIMIZE(ax3,list_PLP,(squeeze(EFF2(5,:,:))),list_parameter,list_snr(l),title_figure1,method)
ax4=subplot(3,2,6)
makeFig_MAXIMIZE(ax4,list_PLP,(squeeze(ACCURACY2(5,:,:))),list_parameter,list_snr(l),title_figure2,method)
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_PLP,(squeeze(F1_SCORE((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure1,method)
    ax2=subplot(3,2,l*2)
    makeFig_MCC(ax2,list_PLP,(squeeze(MCC_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),title_figure2,method)
end 
ax3=subplot(3,2,5)
makeFig_MAXIMIZE(ax3,list_PLP,(squeeze(F1_SCORE2(5,:,:))),list_parameter,list_snr(l),title_figure1,method)
ax4=subplot(3,2,6)
makeFig_MCC(ax4,list_PLP,(squeeze(MCC_all2(5,:,:))),list_parameter,list_snr(l),title_figure2,method)
