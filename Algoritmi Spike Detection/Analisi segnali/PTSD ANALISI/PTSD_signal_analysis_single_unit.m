function [analysis] = singal_analysis_single_unit(stuct,dist_matrix,data)
spikes_found_from_algorithm=find(stuct.peak_train);
NS=length(spikes_found_from_algorithm);
timestamps_from_model=find(dist_matrix.spikeTrain(87,:));
%% Positives
