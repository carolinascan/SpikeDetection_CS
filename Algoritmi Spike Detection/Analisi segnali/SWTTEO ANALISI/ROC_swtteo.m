...
for i=1:length(parametro)
    load([path_MU '\Parametro ' num2str(parametro(i)) '\s1_1_roc.mat'])
    NCS(i,1)=roc.tp;
    FP(i,1)=roc.fp;
    NREF(i,1)=roc.NREF;
    eff(i,1)=roc.eff;
...
XY=[FP_rate TP_rate];
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\coordinate roc swtteo\XY_MU_snr1.mat'],'XY','eff')
...
load('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\SINGLE UNIT DA ANALIZZARE\Gamma\g_SNR1.mat')
for i=1:length(parametro)
    load([path_MU '\Parametro ' num2str(parametro(i)) '\s1_13_roc.mat'])
    NCS(i,1)=roc.tp;
    FP(i,1)=roc.fp;
    NREF(i,1)=roc.NREF;
    eff(i,1)=roc.eff;
...
XY=[FP_rate TP_rate];
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\coordinate roc swtteo\XY_MU_snr13.mat'],'XY','eff')
clear FP_rate TP_rate XY NCS FP NREF eff
%% MULTI UNIT SNR 1.15
path_MU=('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\SWTTEO\MULTI UNIT\')
load('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\SINGLE UNIT DA ANALIZZARE\Gamma\g_SNR1.mat')
for i=1:length(parametro)
    load([path_MU '\Parametro ' num2str(parametro(i)) '\s1_115_roc.mat'])
    NCS(i,1)=roc.tp;
    FP(i,1)=roc.fp;
    NREF(i,1)=roc.NREF;
    eff(i,1)=roc.eff;
...
XY=[FP_rate TP_rate];
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\coordinate roc swtteo\XY_MU_snr115.mat'],'XY','eff')
clear FP_rate TP_rate XY NCS FP NREF eff
%% EXPO SNR 1
load('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\SINGLE UNIT DA ANALIZZARE\Gamma\g_SNR1.mat')
path_expo='C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\SWTTEO\EXPO\'
for i=1:length(parametro)
...
XY=[FP_rate TP_rate];
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\coordinate roc swtteo\XY_expo_snr1.mat'],'XY','eff')
clear FP_rate TP_rate XY NCS FP NREF eff
...
XY=[FP_rate TP_rate];
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\coordinate roc swtteo\XY_expo_snr13.mat'],'XY','eff')
clear FP_rate TP_rate XY NCS FP NREF eff
...
XY=[FP_rate TP_rate];
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SWTTEO ANALISI\coordinate roc swtteo\XY_expo_snr115.mat'],'XY','eff')
clear FP_rate TP_rate XY NCS FP NREF eff
