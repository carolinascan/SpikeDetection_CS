...
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SNEO ANALISI\SNEO\SINGLE UNIT V2\easy\timestamps_found_all.mat'],'timestamps_found_all','elapsed_time','list_multCoeff','list_smooth_factor');
%% load locations
...
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\SNEO ANALISI\SNEO\SINGLE UNIT V2\easy\ANALYSIS.mat'],'TP_all','FP_all','EFF','list_multCoeff','list_snr','TN_all','FN_all','SPECIFICITY','SENSITIVITY','PRECISION','GIT_all','FOR_all','FN_rate_all','FP_rate_all','MCC_all','FDR_all','F1_SCORE','ACCURACY','NPV_all','TS_TP_all','TS_TP_FROM_MODEL_all')
%% 
method='SNEO';
%% PLOTS
high=list_snr(1);
