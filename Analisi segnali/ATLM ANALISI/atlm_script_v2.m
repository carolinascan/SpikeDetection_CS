...
%%
method='PTSD';
list_TimeWindow=linspace(0.5,2.5,5);
list_parameter=1:10;
%%
method='SNEO';
list_TimeWindow=1:10:100;
list_parameter=list_multCoeff;
%% PLOTS
high=list_snr(1);
mid=list_snr(5);
low=list_snr(10);
...
index_name2='FPR';
title_figure1=[0.86 0.29 0.16];
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_TimeWindow,(squeeze(SENSITIVITY((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name,title_figure1(l),method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FP_rate_all((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name2,title_figure1(l),method)
end
savefig('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\FIGURE INDICI\TESI\SNEO\SENSITIVITY_FPR.fig')
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_TimeWindow,(squeeze(PRECISION((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name,title_figure1(l),method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FOR_all((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name2,title_figure1(l),method)
end 
savefig('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\FIGURE INDICI\TESI\SNEO\PRECISIO_FOR.fig')
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_TimeWindow,(squeeze(SPECIFICITY((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name,title_figure1(l),method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FN_rate_all((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name2,title_figure1(l),method)
end 
savefig('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\FIGURE INDICI\TESI\SNEO\SPECIFICITY_FNR.fig')
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_TimeWindow,(squeeze(NPV_all((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name,title_figure1(l),method)
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FDR_ALL((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name2,title_figure1(l),method)
end 
savefig('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\FIGURE INDICI\TESI\SNEO\NPV_FDR.fig')
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_TimeWindow,(squeeze(EFF((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name,title_figure1(l),method)
    ax2=subplot(3,2,l*2)
    makeFig_MAXIMIZE(ax2,list_TimeWindow,(squeeze(ACCURACY((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name2,title_figure1(l),method)
end 
savefig('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\FIGURE INDICI\TESI\SNEO\EFFICIENCY_ACCURACY.fig')
...
for l=1:length(chosen_snr)
    ax=subplot(3,2,l*2-1)
    makeFig_MAXIMIZE(ax,list_TimeWindow,(squeeze(F1_SCORE((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name,title_figure1(l),method)
    ax2=subplot(3,2,l*2)
    makeFig_MCC(ax2,list_TimeWindow,(squeeze(MCC_all((list_snr==chosen_snr(l)),:,:))),list_parameter,index_name2,title_figure1(l),method)
end 
savefig('C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\FIGURE INDICI\TESI\SNEO\F1S_MCC.fig')
...
mkdir(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\ATLM ANALISI\ATLM\SINGLE UNIT V2\easy']);
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\ATLM ANALISI\ATLM\SINGLE UNIT V2\easy\timestamps_found_all.mat'],'timestamps_found_all','elapsed_time','soglia_all','list_parameter','list_TimeWindow');
%% load locations
...
save(['C:\Users\Carolina\Documents\GitHub\SpikeDetection_Carolina\Analisi segnali\ATLM ANALISI\ATLM\SINGLE UNIT V2\easy\ANALYSIS.mat'],'TP_all','FP_all','EFF','list_parameter','list_snr','TN_all','FN_all','SPECIFICITY','SENSITIVITY','PRECISION','GIT_all','FOR_all','FN_rate_all','FP_rate_all','MCC_all','FDR_all','F1_SCORE','ACCURACY','NPV_all','TS_TP_all','TS_TP_FROM_MODEL_all')
%%
method='ATLM'
%% PLOTS
high=list_snr(1);
...
for l=1:length(chosen_snr)
    ...
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FP_rate_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),index_name2,method)
end 
%% PRECISION & FALSE OMISSION RATE
...
for l=1:length(chosen_snr)
    ...
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FOR_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),index_name2,method)
end 
...
for l=1:length(chosen_snr)
    ...
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FN_rate_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),index_name2,method)
end 
%% NEGATIVE PREDICTIVE VALUE & FALSE DISCOVERY RATE
FDR_ALL=FDR_all;
title_figure1='NPV'
...
for l=1:length(chosen_snr)
    ...
    ax2=subplot(3,2,l*2)
    makeFig_MINIMIZE(ax2,list_TimeWindow,(squeeze(FDR_ALL((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),index_name2,method)
end 
...
for l=1:length(chosen_snr)
    ...
    ax2=subplot(3,2,l*2)
    makeFig_MAXIMIZE(ax2,list_TimeWindow,(squeeze(ACCURACY((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),index_name2,method)
end 
...
for l=1:length(chosen_snr)
    ...
    ax2=subplot(3,2,l*2)
    makeFig_MCC(ax2,list_TimeWindow,(squeeze(MCC_all((list_snr==chosen_snr(l)),:,:))),list_parameter,list_snr(l),index_name2,method)
end
%% tabella
snr=5;
w=1;
p=4;
tpr=(SENSITIVITY(snr,p,w))
tnr=(SPECIFICITY(snr,p,w))
ppv=(PRECISION(snr,p,w))
fnr=(FN_rate_all(snr,p,w))
npv=(NPV_all(snr,p,w))
fpr=(FP_rate_all(snr,p,w))
fdr=(FDR_all(snr,p,w))
FoR=(FOR_all(snr,p,w))
csi=(EFF(snr,p,w))
acc=(ACCURACY(snr,p,w))
f1=(F1_SCORE(snr,p,w))
mcc=(MCC_all(snr,p,w))

%%
par=linspace(110,10000,10)
%%
snr=5;
p=6;
tpr=(SENSITIVITY(snr,p))
tnr=(SPECIFICITY(snr,p))
ppv=(PRECISION(snr,p))
fnr=(FN_rate_all(snr,p))
npv=(NPV_all(snr,p))
fpr=(FP_rate_all(snr,p))
fdr=(FDR_all(snr,p))
FoR=(FOR_all(snr,p))
csi=(EFF(snr,p))
acc=(ACCURACY(snr,p))
